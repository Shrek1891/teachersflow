        ...
        <>
            <div className="flex flex-col-reverse items-start justify-between sm:flex-row">
                <div className="flex -flex-col items-start gap-4 lg:flex-row">
                    ...
                    />
                    <div className="mt-3">
                        <h2 className="h2-bold text-dark300_light900">{userInfo?.user.name}</h2>
                        <p className="paragraph-regular text_dark200_light800">@{userInfo?.user.username}</p>
                        <div className="mt-3 flex flex-wrap items-center justify-start">
                            ...
                            />)}
                            {userInfo.user.portfolio && (<ProfileLink
                                imgURL="/assets/icons/link.png"
                                title={userInfo.user.portfolioWebsite}
                            />)}
                            <ProfileLink imgURL="/assets/icons/calendar.png"
                                         title={getJoinedDate(userInfo.user.createdAt)}/>

                        </div>
                        {userInfo.user.bio &&
                            <p className="paragraph-regular text-dark200_light800 mt-8">{userInfo.user.bio}</p>
                        }
                    </div>
                </div>
