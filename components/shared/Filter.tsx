...
const Filter = ({filters, otherClasses, containerClass}: Props) => {
    ...
    const handeUpdateParams = (value: string) => {
    ...
    return (
        ...
        >
            <Select
                onValueChange={handeUpdateParams}
            ...
            >
                ...
                <SelectContent className="text-dark500_light700 small-regular border-none dark:bg-dark-400">
                    <SelectGroup>
                        {filters.map((filter) => (
                            <SelectItem
                                key={filter.name}
